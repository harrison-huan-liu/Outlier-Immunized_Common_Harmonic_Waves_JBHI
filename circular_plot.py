...
datafile1 = 'fisher_amy_new.xlsx'
datafile2 = 'energy_node_e_amy_new.xlsx'
fig1, fig2 = circular_plot(datafile1, datafile2)
fig1.savefig('circular_amy_new.png')
fig2.savefig('colorbar_amy_new.png')
...
# datafile5 = 'fisher_fdg.xlsx'
# datafile6 = 'energy_node_e_fdg.xlsx'
# fig1, fig2 = circular_plot(datafile5, datafile6)
# fig1.savefig('circular_fdg.png')
# fig2.savefig('colorbar_fdg.png')
