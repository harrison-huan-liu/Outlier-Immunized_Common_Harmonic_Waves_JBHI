...
def energy_bar_plot(data, ax1):
    ...
    ax1.text(0.65, data_1[0] + 0.015, r'$*$', color='red', ha='center', va='bottom', fontsize=14)
    ax1.text(0.65, data_1[0] + 0.045, r'$*$', color='red', ha='center', va='bottom', fontsize=14)
    ax1.text(0.65, data_1[0] + 0.075, r'$*$', color='red', ha='center', va='bottom', fontsize=14)
