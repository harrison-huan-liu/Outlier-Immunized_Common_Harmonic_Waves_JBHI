...
def energy_bar_plot(data, ax1):
    ...
    # ax1.text(0.65, data_1[0]-0.015, r'$*$' , color='black', ha = 'center',va = 'bottom', fontsize=14)
    # ax1.text(0.65, data_1[0]+0.015, r'$*$' , color='black', ha = 'center',va = 'bottom', fontsize=14)
    # ax1.text(0.65, data_1[0]+0.045, r'$*$' , color='black', ha = 'center',va = 'bottom', fontsize=14)
    # ax1.text(0.65, data_1[0]+0.075, r'$*$' , color='black', ha = 'center',va = 'bottom', fontsize=14)
...
def energy_bar_plot2(data, ax2):
    ...
    # ax2.text(0.65, data_3[0] + 0.015, r'$*$', color='black', ha='center', va='bottom', fontsize=14)
    # ax2.text(0.65, data_3[0] + 0.045, r'$*$', color='red', ha='center', va='bottom', fontsize=14)
    # ax2.text(0.65, data_3[0] + 0.075, r'$*$', color='black', ha='center', va='bottom', fontsize=14)


datafile1 = 'auroc_amy_ce.xlsx'
data1 = pd.read_excel(datafile1)
fig1, ax1 = plt.subplots(figsize=(6,2))
energy_bar_plot(data1, ax1)
fig1.savefig('auroc_amy_ce.png')
fig2, ax2 = plt.subplots(figsize=(6,2))
energy_bar_plot2(data1, ax2)
fig2.savefig('aupr_amy_ce.png')

datafile2 = 'auroc_tau_ce.xlsx'
data2 = pd.read_excel(datafile2)
fig3, ax3 = plt.subplots(figsize=(6,2))
energy_bar_plot(data2, ax3)
fig3.savefig('auroc_tau_ce.png')
fig4, ax4 = plt.subplots(figsize=(6,2))
energy_bar_plot2(data2, ax4)
fig4.savefig('aupr_tau_ce.png')

datafile3 = 'auroc_fdg_ce.xlsx'
data3 = pd.read_excel(datafile3)
fig5, ax5 = plt.subplots(figsize=(6,2))
energy_bar_plot(data3, ax5)
fig5.savefig('auroc_fdg_ce.png')
fig6, ax6 = plt.subplots(figsize=(6,2))
energy_bar_plot2(data3, ax6)
fig6.savefig('aupr_fdg_ce.png')
fig6.savefig('aupr_fdg_ce.svg',format='svg')
