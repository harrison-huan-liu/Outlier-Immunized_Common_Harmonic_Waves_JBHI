function [Objectnums_reduce,auc,aupr]=Classification_original(CN,LMCI,select_CN_LMCI_same,select)
...
if Objectnums_less==Objectnums_CN
    for i=1:Objectnums_less
        total_data{i,1}=CN(1:148,i);
        total_data{i+Objectnums_less,1}=LMCI(1:148,select_CN_LMCI_same(i));
    end
else
    for i=1:Objectnums_less
        total_data{i,1}=CN(1:148,select_CN_LMCI_same(i));
        total_data{i+Objectnums_less,1}=LMCI(1:148,i);
    end
end
